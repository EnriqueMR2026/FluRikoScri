    ...
    MenuPrincipal { // Tiene 5 Botones verticalmente |  Ya construido
        ...
        Nomina { // Ya construido
            ...
            CalculadoraEnTiempoReal {
                ...
                Se ejecuta localmente usando Custom Function sin gastar lecturas.
                Bloqueo por Falta: Si App State (turnoIniciado) es False, la calculadora se congela porque no hay registro de entrada.
            }
            SincronizacionDeLecturas {
                Sueldo Base: Solo hace lectura a Firestore el día 1 de cada mes para saber si ya se le subio su sueldo o no.
                Propinas/Bonos: Solo hace lectura a Firestore todos los días a partir de las 12:00 PM (Mediodía).
            }
            MuestraEnPantalla {
                nombreEmpleado, numeroEmpleado, telefono, correo, sueldoAcumulado (calculadora), bonosPropinas, bonos, faltas, retardos, repocision, y neto a pagar (calculadora).
            }
        }
        
        Asistencia {  // Ya construido
